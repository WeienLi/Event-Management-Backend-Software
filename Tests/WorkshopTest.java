...
public class WorkshopTest {
    ...
    static void setup(){
        ...
        e1 = Workshops.getWorkshop("Barry", Location.BellCentre,date,10.0,50);
        e2 = Workshops.getWorkshop("Tour", Location.OlympicStadium,date,9.0,40);
        e3 = Workshops.getWorkshop("Tour",date);
    ...
    void test2(){
        ...
        assertEquals(Workshops.getAevents().size(),4);
    }
    ...
    void test4(){
        ...
        try {
            Field f1 = Workshops.class.getDeclaredField("prereq");
            f1.setAccessible(true);
            Object o1 = f1.get(e10);
            ArrayList<Workshops> test = new ArrayList<>();
            test.add(w1);
