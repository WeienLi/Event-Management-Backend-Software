...
public class ScreeningTest {
    ...
    static void setup(){
        ...
        e1 = Screening.getScreening("Barry", Location.BellCentre,date,10.0,50,Rating.PG13);
        e2 = Screening.getScreening("Tour", Location.OlympicStadium,date,9.0,40,Rating.R);
    ...
    void test2(){
        ...
        assertEquals(Screening.getAevents().size(),4);
    }
    ...
    void test7(){
        ...
        try {
            Field f1 = Screening.class.getDeclaredField("arating");
            f1.setAccessible(true);
            Object o1 = f1.get(e10);
            assertEquals(o1,Optional.of(Rating.R));
